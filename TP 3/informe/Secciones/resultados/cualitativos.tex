...
\begin{figure}
\hfill
\subfigure[Escena 1]{\includegraphics[width=.4\linewidth]{imagenes/cualitativos/BSS2.png}}
\hfill
\subfigure[Escena 2]{\includegraphics[width=.4\linewidth]{imagenes/cualitativos/BSS1.png}}
\hfill
